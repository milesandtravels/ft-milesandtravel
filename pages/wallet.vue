  ...
  <div class="wallet-page">
    <v-container fluid class="pa-4 pa-sm-6">
      ...
      >
        <v-card-text>
          ...
          <p class="text-body-1 text-medium-emphasis mb-6">
            Adicione seus programas de pontos e milhas para começar a acompanhar seus saldos.
          </p>
          <v-btn
            color="primary"
            size="large"
          ...
          <div v-if="availablePrograms.length === 0" class="text-caption text-medium-emphasis mt-2">
      ...
      <div v-else class="wallet-grid">
        <TransitionGroup name="wallet-cards" tag="div" class="wallet-cards-container">
          <WalletCard
...
useSeoMeta({
  ...
  description: 'Gerencie seus pontos e milhas acumulados em diferentes programas de fidelidade',
  ogDescription: 'Gerencie seus pontos e milhas acumulados em diferentes programas de fidelidade',
})
