  ...
  <v-container fluid class="searches-page">
        ...
        <div class="d-flex align-center justify-space-between flex-wrap mb-4">
          <div>
            ...
            <p class="text-body-1 text-medium-emphasis">
              Acesse rapidamente suas pesquisas anteriores e continue de onde parou
            </p>
          </div>
    ...
    <div v-else-if="!searches.length" class="empty-state">
      ...
      <p class="text-body-1 text-medium-emphasis mb-6">
        Você ainda não realizou nenhuma busca. Comece agora e encontre os melhores produtos com cashback!
      </p>
      <v-btn
        color="primary"
        size="large"
