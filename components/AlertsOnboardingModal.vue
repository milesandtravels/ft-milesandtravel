      ...
      <v-card-text>
        <div class="text-center mb-6">
          <p class="text-body-1 text-medium-emphasis">
            Configure o WhatsApp para receber notificações instantâneas sobre as melhores ofertas e cashbacks.
          </p>
        </div>
...
const steps = [
  ...
  },
  {
    ...
    description: 'Defina os alertas para as ofertas que você deseja acompanhar'
  },
  {
    color: 'warning',
    title: 'Receba Notificações',
    description: 'Seja notificado instantaneamente quando suas ofertas favoritas estiverem disponíveis'
  }
]
</script>
