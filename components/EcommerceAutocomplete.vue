<template>
  <div class="mb-6">
    <v-label class="text-subtitle-1 font-weight-medium mb-3 d-block">Buscar Marketplace</v-label>
    ...
    <v-autocomplete
      ...
      :error-messages="errorLoadingEcommerces ? 'Erro ao carregar marketplaces' : []"
      class="mb-3"
