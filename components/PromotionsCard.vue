          ...
          <div class="modal-header">
            <div class="d-flex align-center pa-6 pb-4">
              ...
              <div class="flex-grow-1">
                <h2 class="text-h6 font-weight-bold mb-1">Atenção - Regras do Programa</h2>
        ...
        <v-card-text class="pa-6">
          ...
          <div class="program-info-section mb-5">
            <div class="d-flex align-center">
              ...
              <div class="flex-grow-1">
                <h3 class="text-h6 font-weight-bold mb-1">{{ promotion.program.name }}</h3>
                <p class="text-body-2 text-medium-emphasis mb-0">
          ...
          >
            <div class="text-body-2">
              <strong>Importante:</strong> Você será redirecionado para o site oficial do programa {{ promotion.program.name }}.
            </div>
          </v-alert>
          ...
          <div class="guidelines-section">
            <h4 class="text-subtitle-1 font-weight-bold mb-3 d-flex align-center">
              <v-icon class="mr-2" color="primary" size="20">mdi-clipboard-check-outline</v-icon>
            ...
            <div class="disclaimer mt-4 pa-3">
              <v-icon class="mr-2" color="grey" size="16">mdi-shield-alert-outline</v-icon>
              <span class="text-body-2 text-medium-emphasis">
                O Miles&Travels não se responsabiliza por alterações nas regras ou valores dos programas de fidelidade.
              </span>
            </div>
          </div>
        </v-card-text>
...
function goToProgram(): void {
  window.open(props.promotion.program.link_url, '_blank', 'noopener,noreferrer')
...
.v-theme--dark .modal-header {
  background: linear-gradient(135deg, rgba(255, 247, 230, 0.05) 0%, rgba(255, 255, 255, 0.02) 100%);
  border-color: rgba(255, 255, 255, 0.08);
}
