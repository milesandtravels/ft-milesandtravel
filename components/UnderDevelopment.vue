      ...
      <v-row display="flex" align="center" justify="center">
        <v-col cols="12" sm="12" md="12" lg="12" xl="12">
          ...
          >
            ...
            <!-- Subtitle -->
            <p class="text-body-1 text-md-h6 font-weight-medium mb-4 text-medium-emphasis">
              {{ subtitle }}
            </p>

            <!-- Description -->
            <p class="text-body-2 text-md-body-1 mb-6 text-high-emphasis description-text">
              {{ description }}
            </p>
...
const props = withDefaults(defineProps<Props>(), {
  ...
  description: 'Nossa equipe está trabalhando para trazer esta nova funcionalidade para você. Fique atento às atualizações!',
  showBackButton: true,
