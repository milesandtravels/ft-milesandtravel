<template>
  <v-container class="pa-2 pa-md-4">
    ...
    <div v-else-if="hasSearched" class="empty-state text-center py-8 py-md-12">
      <v-icon class="mb-3" color="grey-lighten-1" size="48">mdi-magnify-remove</v-icon>
      <h3 class="text-body-1 text-md-h6 font-weight-medium mb-2">Nenhum produto encontrado</h3>
    ...
    <div v-else class="initial-state text-center py-8 py-md-12">
      ...
      <h3 class="text-body-1 text-md-h6 font-weight-medium mb-2">Pronto para buscar!</h3>
      <p class="text-body-2 text-medium-emphasis">
