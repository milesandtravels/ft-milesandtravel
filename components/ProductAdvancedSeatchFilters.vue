                ...
                >
                  <template #prepend>
                    <v-checkbox-btn
                      ...
                      :indeterminate="isSomeEcommercesSelected && !isAllEcommercesSelected"
                      color="primary"
                    />
                  </template>
                </v-list-item>
...
const isSomeEcommercesSelected = computed(() => {
  return selectedEcommerces.value.length > 0 && selectedEcommerces.value.length < ecommerceOptions.value.length
})
